...
<body>
    ...
    <div class="container contact-container">
        <div class="card shadow p-4">
            <h2 class="text-center mb-4" style="color: #e63946 !important; text-transform: uppercase !important; letter-spacing: 3px !important; text-shadow: 0 0 15px rgba(230, 57, 70, 0.9), 0 0 30px rgba(230, 57, 70, 0.6), 3px 3px 6px rgba(0, 0, 0, 0.9) !important; animation: flicker 4s infinite alternate; font-weight: bold !important; position: relative; z-index: 2;">¡Bienvenido <?php echo htmlspecialchars($nombre); ?>!</h2>

            <div class="row justify-content-center">
                <div class="col-auto">
                    <a href="../controlador/acciones_usuario.php?accion=cerrar" class="btn" onclick='return confirmar()' style="background: linear-gradient(135deg, #6a1b1b 0%, #0f1626 100%) !important; border: 2px solid #e63946 !important; box-shadow: 0 0 20px rgba(230, 57, 70, 0.6) !important; text-transform: uppercase !important; letter-spacing: 2px !important; color: #a8dadc !important; font-weight: bold !important; padding: 12px 20px !important;">Cerrar Sesion</a>
                </div>
            </div>
