        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav2">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="" style="color: #a8dadc !important; font-size: 14px !important; text-transform: uppercase !important; letter-spacing: 1.5px !important; padding: 10px 15px !important; border: 2px solid transparent !important; border-radius: 4px !important; margin: 0 5px !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important;">Sucursales</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="card shadow p-4">
            ...
            <form action="../controlador/acciones_menu.php?accion=editar" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <img src="../uploads/<?php echo $menu[0]['imagen']; ?>"class='img-fluid' alt='' style='width: 80px; height: 80px; object-fit: contain; border-radius: 8px; border: 2px solid #2a2a3e !important; box-shadow: 0 0 10px rgba(230, 57, 70, 0.3) !important;'>
                </div>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" onclick="return confirmar_edicion()" class="btn w-100" style="background: linear-gradient(135deg, #e63946 0%, #c1121f 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 20px rgba(230, 57, 70, 0.6) !important; text-transform: uppercase !important; letter-spacing: 2px !important; color: #a8dadc !important; font-weight: bold !important; padding: 12px !important;">Editar</button>
                    <button type="button" onclick="cancelar_edicion()" class="btn w-100" style="background: linear-gradient(135deg, #2a2a3e 0%, #1a1a2e 100%) !important; border: 2px solid #e63946 !important; box-shadow: 0 0 15px rgba(230, 57, 70, 0.4) !important; text-transform: uppercase !important; letter-spacing: 2px !important; color: #a8dadc !important; font-weight: bold !important; padding: 12px !important;">Cancelar</button>
                </div>
