                ...
                echo '
                    <div class="card shadow p-4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-auto">
                                <button class="btn" onclick="Mostrar('.$r['id_reserva'].')" style="background: linear-gradient(135deg, #1a535c 0%, #0f1626 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 15px rgba(78, 205, 196, 0.5) !important; text-transform: uppercase !important; letter-spacing: 1px !important; color: #a8dadc !important; padding: 10px 25px !important;">Ver más</button>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-auto">
                                <button class="btn" onclick="eliminarReserva(\''.$r['id_reserva'].'\', \''.addslashes($r['nombres']).'\')" style="background: linear-gradient(135deg, #e63946 0%, #c1121f 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 15px rgba(230, 57, 70, 0.5) !important; text-transform: uppercase !important; letter-spacing: 1px !important; color: #a8dadc !important; padding: 10px 25px !important;">Cancelar</button>
                            </div>
                        </div>
                    </div>
                    <br>
