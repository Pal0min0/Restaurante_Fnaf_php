...
<body>
                        ...
                        foreach($lista_usuarios as $u){
                            echo "
                                <tr>
                                    ...
                                    <td>{$u['telefono']}</td>
                                    <td>
                                    <a href='./editar_usuario.php?id_usuario={$u['id_usuario']}' class='btn' style='background: linear-gradient(135deg, #1a535c 0%, #0f1626 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 10px rgba(78, 205, 196, 0.5) !important; text-transform: uppercase !important; letter-spacing: 1px !important; color: #a8dadc !important;'>Editar</a>
                                    </td>
                                    <td>
    ...
    <div class="container contact-container">
        <div class="card shadow p-4">
            <h2 class="text-center mb-4" style="color: #e63946 !important; text-transform: uppercase !important; letter-spacing: 3px !important; text-shadow: 0 0 15px rgba(230, 57, 70, 0.9), 0 0 30px rgba(230, 57, 70, 0.6), 3px 3px 6px rgba(0, 0, 0, 0.9) !important; animation: flicker 4s infinite alternate; font-weight: bold !important; position: relative; z-index: 2;">Registrar Usuario</h2>
