...
<style> 
    * {
    ...
    /* Estilos para las tablas y formularios */
    .card {
...
<body>
    ...
    <div class="container mt-3 mb-4">
        <div class="card shadow p-4">
            <h2 style="color: #e63946 !important; text-transform: uppercase !important; letter-spacing: 3px !important; text-shadow: 0 0 15px rgba(230, 57, 70, 0.9), 0 0 30px rgba(230, 57, 70, 0.6), 3px 3px 6px rgba(0, 0, 0, 0.9) !important; animation: flicker 4s infinite alternate; font-weight: bold !important; position: relative; z-index: 2;">Menu</h2>         
                        ...
                        foreach($lista_menu as $m){
                            echo "
                                <tr>
                                    ...
                                    <td>{$m['descripcion']}</td>
                                    <td>
                                        <img src='../uploads/{$m['imagen']}' class='img-fluid' alt='' style='width: 80px; height: 80px; object-fit: contain; border-radius: 8px; border: 2px solid #2a2a3e !important; box-shadow: 0 0 10px rgba(230, 57, 70, 0.3) !important;'>
                                    </td>
                                    <td>\${$m['precio']}</td>
                                    <td>{$m['tipo_menu']}</td>
                                    <td>
                                        <a href='./editar_menu.php?id_menu={$m['id_menu']}' class='btn' style='background: linear-gradient(135deg, #1a535c 0%, #0f1626 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 10px rgba(78, 205, 196, 0.5) !important; text-transform: uppercase !important; letter-spacing: 1px !important; color: #a8dadc !important;'>Editar</a>
                                    </td>
                                    <td>
                                        <form action='../controlador/acciones_menu.php?accion=eliminar' method='POST' style='display:inline;'>
                                            <input type='hidden' name='id_menu' value='{$m['id_menu']}'>
                                            <button type='submit' class='btn' style='background: linear-gradient(135deg, #e63946 0%, #c1121f 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 10px rgba(230, 57, 70, 0.5) !important; text-transform: uppercase !important; letter-spacing: 1px !important; color: #a8dadc !important;' onclick='return confirmarEliminar()'>Eliminar</button>
                                        </form>
                                    </td>
                                </tr>
                            ";
                        ...
                        echo '
                            <script>
                                function confirmarEliminar() {
                                    return confirm("¿Estás seguro de eliminar este plato?");
                                }
                            </script>
                        ';
    ...
    <div class="container contact-container">
        <div class="card shadow p-4">
            <h2 class="text-center mb-4" style="color: #e63946 !important; text-transform: uppercase !important; letter-spacing: 3px !important; text-shadow: 0 0 15px rgba(230, 57, 70, 0.9), 0 0 30px rgba(230, 57, 70, 0.6), 3px 3px 6px rgba(0, 0, 0, 0.9) !important; animation: flicker 4s infinite alternate; font-weight: bold !important; position: relative; z-index: 2;">Registrar Plato</h2>
