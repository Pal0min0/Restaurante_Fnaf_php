...
<body>
    ...
    <!-- Formulario de edicion de sucursal -->
    <div class="container contact-container">
        <div class="card shadow p-4">
            <h2 class="text-center mb-4" style="color: #e63946 !important; text-transform: uppercase !important; letter-spacing: 3px !important; text-shadow: 0 0 15px rgba(230, 57, 70, 0.9), 0 0 30px rgba(230, 57, 70, 0.6), 3px 3px 6px rgba(0, 0, 0, 0.9) !important; animation: flicker 4s infinite alternate; font-weight: bold !important; position: relative; z-index: 2;">Editar Sucursal</h2>

            <?php
                if (isset($_SESSION['success_message'])) {
                    echo '<div class="alert alert-success">Sucursal actualizada correctamente - <a href="./panel_sucursal.php">Ir a Panel Sucursal</a></div>';
            ...
            <form action="../controlador/acciones_sucursal.php?accion=editar" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <img src="../uploads/<?php echo $sucursal[0]['imagen']; ?>"class='img-fluid' alt='' style='width: 80px; height: 80px; object-fit: contain; border-radius: 8px; border: 2px solid #2a2a3e !important; box-shadow: 0 0 10px rgba(230, 57, 70, 0.3) !important;'>
                </div>
                <div class="mb-3">
                    ...
                    echo '
                        <script>
                            ...
                            function confirmar_edicion() {
                                return confirm("¿Estás seguro de quieres editar esta sucursal?");
                            }
                        </script>
                    '
                ?>
