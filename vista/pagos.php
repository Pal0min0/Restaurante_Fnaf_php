...
<style> 
    * {
    ...
    .modal-content {
        ...
        box-shadow: 0 0 30px rgba(230, 57, 70, 0.6) !important;
        color: #a8dadc !important;
    }
...
<body>
                        ...
                        <form action="../controlador/acciones_pedido.php?accion=crear" method="POST">
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="fw-bold fs-4" style="color: #4ecdc4 !important; text-shadow: 0 0 10px rgba(78, 205, 196, 0.7) !important;">
                                  ...
                                  <table class="table">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td><input type="radio" name="opcion" value="opcion1" style="accent-color: #e63946;"> Contra entrega</td>
                                        <td><input type="radio" name="opcion" value="opcion2" id="op1" style="accent-color: #e63946;"> Pagar online</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  ...
                                  <table class="table forma_pago" style="display: none;">
                                    ...
                                    <tbody>
                                      <tr class="d-flex">
                                        <td><input type="radio" name="opcion" value="opcion1" style="accent-color: #e63946;"> Debito</td>
                                        <td><input type="radio" name="opcion" value="opcion2" style="accent-color: #e63946;"> De credito</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  ...
                                  <table class="table forma_pago" style="display: none;">
                                    ...
                                    <tbody>
                                      <tr class="d-flex">
                                        <td><input type="radio" name="opcion" value="opcion1" style="accent-color: #e63946;"> PayPal</td>
                                        <td><input type="radio" name="opcion" value="opcion2" style="accent-color: #e63946;"> Apple Pay</td>
                                        <td><input type="radio" name="opcion" value="opcion2" style="accent-color: #e63946;"> Google Pay</td>
                                      </tr>
                                    </tbody>
                                  </table>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-auto">
                                  <?php if(!$visible): ?>
                                      <button type="button" id="btnFinal" class="btn" style="background: linear-gradient(135deg, #e63946 0%, #c1121f 100%) !important; border: 2px solid #2a2a3e !important; box-shadow: 0 0 20px rgba(230, 57, 70, 0.6) !important; text-transform: uppercase !important; letter-spacing: 2px !important; color: #a8dadc !important; font-weight: bold !important; padding: 12px 20px !important; margin-right: 10px;">Final Compra</button>
                                      <button type="button" class="btn" onclick='return confirmar()' style="background: linear-gradient(135deg, #2a2a3e 0%, #1a1a2e 100%) !important; border: 2px solid #e63946 !important; box-shadow: 0 0 15px rgba(230, 57, 70, 0.4) !important; text-transform: uppercase !important; letter-spacing: 2px !important; color: #a8dadc !important; font-weight: bold !important; padding: 12px 20px !important;">Cancelar</button>
                                  <?php else: ?>
                                      <button type="button" id="btnFinal" class="btn" style="background: linear-gradient(135deg, #2a2a3e 0%, #1a1a2e 100%) !important; border: 2px solid #666 !important; text-transform: uppercase !important; letter-spacing: 2px !important; color: #666 !important; font-weight: bold !important; padding: 12px 20px !important;" disabled>Final Compra</button>
                                  <?php endif; ?>
                                </div>
                            </div>
                        </form>
    ...
    <div class="modal-dialog mx-auto d-block">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <hr style="border-color: #e63946 !important;">
    ...
    <script>
      ...
      function confirmar() {
          return confirm("¿Estás seguro de que quieres cancelar la compra?");
      }
    </script>
